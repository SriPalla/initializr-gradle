 ...
 * @contributor plq6883
 */
abstract class AbstractProjectGeneratorTest {
	...
	void setup() {
		...
		projectGenerator.requestResolver = new ProjectRequestResolver(postProcessors)
	}
	...
	ProjectRequest createProjectRequest(String... styles) {
		...
		// setting project type to gradle since maven projects are not generated by current project
