...
class InitializrProperties extends InitializrConfiguration {
	 ...
	 */
	@JsonIgnore
	final SimpleElement groupId = new SimpleElement(value: 'com.usaa.template')
	 ...
	 */
	@JsonIgnore
	final SimpleElement name = new SimpleElement(value: 'template-creation')

	/**
	 * Description metadata.
	 */
	@JsonIgnore
	final SimpleElement description = new SimpleElement(value: 'This is my project description')
